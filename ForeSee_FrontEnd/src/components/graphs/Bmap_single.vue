    ...
    series : [
        ...
        },
        {
            ...
            data: convertData(data.sort(function (a, b) {
                ...
                name: '测试', value: [125.03,46.58,780], stock_code: '600433'
            }),
            // data: data2,
            symbolSize: function (val) {
                return val[2] / 10;
...
myChart.on('click', function(param) {
        ...
        // console.log(param.data.stock_code); //获取热词名称
        // window.open('http://localhost:8890/#/multi?query='+param.data.name);
        window.open(href + 'detail?stockCode='+ param.data.stock_code);
      });
