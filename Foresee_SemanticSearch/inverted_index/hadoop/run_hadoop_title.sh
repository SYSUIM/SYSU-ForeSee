...
HDFS=/student/bd61
OUTPUT_STAGE_A=/title_index/STAGE_A/
OUTPUT_STAGE_B=/title_index/STAGE_B/
OUTPUT_STAGE_C=/title_index/STAGE_C/
...
# 	-input ${INPUT}/news_title.txt -output ${HDFS}${OUTPUT_STAGE_A} \
...
# 	hadoop dfs -cat ${HDFS}${OUTPUT_STAGE_B}part* >  output/title/title_index_$i.txt
# 	hadoop dfs -rm -r ${HDFS}${OUTPUT_STAGE_B}
# done

hadoop dfs -mkdir ${HDFS}${OUTPUT_STAGE_B}
hadoop dfs -put output/title/title_index_*.txt ${HDFS}${OUTPUT_STAGE_B}
...
hadoop dfs -cat ${HDFS}${OUTPUT_STAGE_C}part* >  output/title_index.txt
