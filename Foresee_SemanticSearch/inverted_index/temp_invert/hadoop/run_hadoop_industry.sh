...
HDFS=/student/bd61
OUTPUT_STAGE_A=/industry_index/STAGE_A/
OUTPUT_STAGE_B=/industry_index/STAGE_B/
...
$HADOOP_HOME/hadoop jar /usr/hadoop/hadoop-2.7.3/share/hadoop/tools/lib/hadoop-streaming-2.7.3.jar \
	-input ${INPUT}/industry_preprocess.txt -output ${HDFS}${OUTPUT_STAGE_A} \
...
hadoop dfs -put preprocess/industry/industry_tokenized.txt ${HDFS}${OUTPUT_STAGE_A} 
...
hadoop dfs -cat ${HDFS}${OUTPUT_STAGE_B}part* >  output/industry_index.txt